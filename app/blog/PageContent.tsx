...
const Blog = () => {
  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Explore interior design trends from 2024, from sustainable materials to bold color choices.',
    ...
    },
    {
      ...
      readTime: '6 min read',
      category: 'trends',
      slug: 'sustainable-interior-design-practices',
      featured: false
    }
  ];
  ...
  const categories = [
    ...
    { id: 'trends', name: 'Trends & Sustainability' },
    { id: 'tips', name: 'Tips & Advice' },
    { id: 'color', name: 'Color Theory' },
  ].map(category => ({ ...category, count: blogPosts.filter(post => category.id === 'all' || post.category === category.id).length }));
